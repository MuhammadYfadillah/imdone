...
# Load data heatmap
polusi1 = pd.read_csv("shunyixPM25.csv")  # Ganti dengan nama file CSV
polusi2 = pd.read_csv("shunyixPM10.csv")  # Ganti dengan nama file CSV
polusi3 = pd.read_csv("tiantanxPM25.csv")  # Ganti dengan nama file CSV
polusi4 = pd.read_csv("tiantanxPM10.csv")  # Ganti dengan nama file CSV

# Load data plotline
cuaca1 = pd.read_csv("shunyiRAIN.csv")  # Ganti dengan nama file CSV
cuaca2 = pd.read_csv("shunyiTEMP.csv")  # Ganti dengan nama file CSV
cuaca3 = pd.read_csv("tiantanRAIN.csv")  # Ganti dengan nama file CSV
cuaca4 = pd.read_csv("tiantanRAIN.csv")  # Ganti dengan nama file CSV
